...
<%@page import="org.dspace.googlestats.ItemViewCounter" %>
    ...
    <table align="center" class="miscTable">
        <tr>
            <td class="oddRowEvenCol" align="center">
                This item has been viewed <strong><%= count %>
            </strong> times in the last year. <a
                    href="<%= request.getContextPath() %>/gastatistics?handle=<%= item.getHandle() %>"><fmt:message
