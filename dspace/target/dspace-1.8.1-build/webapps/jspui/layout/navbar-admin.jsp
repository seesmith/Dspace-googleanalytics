...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr class="navigationBarItem">
    <td>
      <img alt="" src="<%= request.getContextPath() %>/image/<%= (currentPage.endsWith("/gastatistics/full") ? "arrow-highlight" : "arrow") %>.gif" width="16" height="16"/>
    </td>
    <td nowrap="nowrap" class="navigationBarItem">
      <a href="<%= request.getContextPath() %>/gastatistics/full"><fmt:message key="jsp.layout.navbar-admin.gastatistics"/></a>
    </td>
  </tr>
